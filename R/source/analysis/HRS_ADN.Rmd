...
folder_standard <- "Z:/Nathan/Code/TFL/R/data/HRS/TAD_2_3/standard"

path_values <- "Z:/Nathan/Code/TFL/R/data/HRS/TAD_2_3/HRS"
...
HRS <- qPCR_HRS(df_values = df_import,
                HRS_tag = "H",
                loop_tag = "B")
...
qPCR_import_v2 <- function(folder_standard, 
                        path_values){
...
qPCR_HRS_v2 <- function(df_values,
                     HRS_tag,
                     loop_tag,
                     path_output = NULL){
